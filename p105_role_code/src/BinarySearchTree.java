...
//        //left rotation - rotated node is left child
//    	if (parent.down[0] == child) {
//            // Left rotation (child is left child of the parent)
//    		parent.down[0] = leftChild;
//    	    if (leftChild != null) {
//    	        leftChild.up = parent;
//    	    }
//
//    	    // Update child's parent and grandparent references
//    	    child.down[0] = parent;
//    	    parent.up = child;
...
//    	
    	...
    	//right rotation - rotated node is right child
//    	if (parent.down[1] == child) {
//            
//        	parent.down[1] = rightChild;
//            if (rightChild != null) {
...
//    	else {
//            
//            throw new IllegalArgumentException("No parent-child relationship between given nodes");
//        }
    	...
    	//check if parent is root node; if not, move child up to parent spot with grandparent referencing child
    	boolean isRight = child.isRightChild();
    	if(parent.up != null)
		{
			if(parent.isRightChild())
			{
    	...
    	//child becomes new root of the tree
    	else
    	{
    		root = child;
    		child.up = null;
...
//    	
    ...
    /**
     * tester for right rotation
     * 
     * @return true if tree is ordered correctly, false otherwise
     */
    public static boolean test1() {
        ...
        BinarySearchTree.Node<Integer> child = parent.down[1];
        tree.rotate(child, parent);

        // Check if the tree is correctly rotated
        return tree.toInOrderString().equals("[ 10, 15, 20, 25, 30 ]");
       // return false;
    }
    
    /**
     * tester for left rotation
     * 
     * @return true if tree is ordered correctly, false otherwise
     */
    public static boolean test2() {
        ...
        BinarySearchTree.Node<Integer> parent = tree.root;
        BinarySearchTree.Node<Integer> child = parent.down[0];
        tree.rotate(child, parent);
    ...
    //double rotation
    /**
     * tester to check if rotate() works for a double (left-right) rotation
     * 
     * @return true if root matches expected value, false otherwise
     */
    public static boolean test3() {
        ...
        //nodes that need double rotation
        BinarySearchTree.Node<Integer> grandparent = tree.root;
        BinarySearchTree.Node<Integer> parent = grandparent.down[0];
        BinarySearchTree.Node<Integer> child = parent.down[1];

        System.out.println("rotation 1(gp): " + grandparent.data);
        System.out.println("rotation 1(p): " + parent.data);
        System.out.println("rotation 1(c): " + child.data);
        
        //do double rotation
        // left rotation
        tree.rotate(child, parent);
        
        //parent = grandparent.down[1];
        //child = parent.down[1];
        
        System.out.println("rotation 2(gp): " + grandparent.data);
        System.out.println("rotation 2(p): " + parent.data);
        System.out.println("rotation 2(c): " + child.data);
        
        //right rotation
        tree.rotate(child, grandparent);
        System.out.println(tree.root.data);

        // Check if the tree is correctly balanced after double rotation
        return child.data.equals(tree.root.data);
    }
