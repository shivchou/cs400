    ...
    private static class RBTIterator<R> implements Iterator<R> 
    {
  	...
  	public static void testTypes()
  	{
		...
		RBTIterator<Integer> intIt = (RBTIterator<Integer>) testInt.iterator();
  		...
  		System.out.println("test types test 1 pass");
  		
  		Assertions.assertTrue(strIt.next().equals("arryn"));
  		
  		System.out.println("test types test 2 pass");
  	...
  	public static void testDups()
  	{
  		...
  		System.out.println(checkDup.data);
  		
  		Assertions.assertTrue(checkDup.down[1].data == 2);
  		
  		System.out.println("duplicates pass");
  	...
  	public static void testIterator()
  	{
  		...
  		RBTIterator<Integer> it = (RBTIterator<Integer>) test.iterator(); //returns new RBTIterator
  		
  		Assertions.assertTrue(it.next() == 1);
  		
  		System.out.println("iterator test 1 pass");
  		
  		test.setIterationStartPoint(5);
  		
  		RBTIterator<Integer> it1 = (RBTIterator<Integer>) test.iterator(); //returns new RBTIterator
  		
		Assertions.assertTrue(it1.next() == 5);
  		
  		System.out.println("iterator test 2 pass");
